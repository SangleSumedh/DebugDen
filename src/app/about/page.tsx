      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50/50 dark:bg-slate-900/50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
              Passionate people building the future of developer communities
            </p>
          </motion.div>
          ...
          >
            {team.map((member, index) => (
              <motion.div
                ...
                className="group"
              >
                <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 overflow-hidden group-hover:shadow-xl group-hover:border-purple-300 dark:group-hover:border-purple-500 transition-all duration-300">
                  <CardContent className="p-0">
                    <div className="relative h-48 bg-gradient-to-br from-purple-500/20 to-blue-500/20">
                      ...
                      <div className="absolute -bottom-6 left-6 w-20 h-20 rounded-2xl border-4 border-white dark:border-slate-800 bg-slate-300 dark:bg-slate-600" />
                    </div>
